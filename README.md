...
What's to be learned from this? Well, I find I think it's valuable to challenge the notion that apartments need to be on major corridors. Having lived in two apartments in the city, one at the intersection of Morrison and 20th, and one on a quiet residential street I can personally attest to the value of being on a quiet street. I definitely sleep better now at least, and I'm three blocks from the bus stop rather than being right next to it - not a significant change for my own transit accessibility. In the future, I'd like to investigate the physical location of new apartments. I'd suspect that most of the new apartments (especially by # of units) are being built along major corridors. But that was outside the scope of my chosen data source of OpenStreetMap
